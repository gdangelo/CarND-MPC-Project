    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          // Fit a 3rd order polynomial for the reference line
          double* ptr_waypoints_x = &waypoints_x[0];
          double* ptr_waypoints_y = &waypoints_y[0];
          Eigen::Map<Eigen::VectorXd> waypoints_x_eigen(ptr_waypoints_x, waypoints_x.size());
          Eigen::Map<Eigen::VectorXd> waypoints_y_eigen(ptr_waypoints_y, waypoints_y.size());
